...
from dSigmadY_sleptons_100_100000_100000_tagged_elastic_m100GeV import *
...
plt.plot(wvalues[3][:303], [value * 1000 for value in elas_1200[3][:303]], label="elastic - p detected", linestyle="solid", linewidth=3, color="blue")
#plt.plot(wvalues[3][:303], [value * 1000 for value in elas_750[3][:303]], label=r"elastic - p detected ($\sqrt{s}=0.75$ TeV)", linestyle=(0, (5, 2, 1, 2, 1, 2)), linewidth=3, color="red")
plt.plot(wvalues[3][:303], [value * 1000 for value in inel_1200[3][:303]], label=r"$M_N < 100$ GeV ($Q^2_p < 10^5$ GeV$^2$)", linestyle="dashed", linewidth=3, color="green")
plt.plot(wvalues[3][:303], [value * 1000 for value in inel_750[3][:303]], label=r"$M_N < 100$ GeV ($Q^2_p < 10^5$ GeV$^2$) ($\sqrt{s}=0.75$ TeV)", linestyle="dotted", linewidth=3, color="magenta")
...
plt.savefig("dSigmadY_sleptons100GeV_25April_JHEP_Krzysztof.pdf")
#plt.savefig("dSigmadY_sleptons100GeV_25April_JHEP_Krzysztof.jpg")
