...
plt.text(0.650, 0.730, info_text, transform=ax.transAxes, ha='center', va='center', color='black')

info_text_2 = "$M_{\widetilde{\ell}}$ = 200 GeV"
plt.text(0.650, 0.650, info_text_2, transform=ax.transAxes, ha='center', va='center', color='black')
