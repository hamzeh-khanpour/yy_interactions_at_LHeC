...
# Print total entries to the console
    ...
    hist3.GetYaxis().SetRangeUser(0.1, 10.0)
    hist4.GetYaxis().SetRangeUser(0.1, 10.0)
    ...
    hist3.GetYaxis().SetRangeUser(0.1, 10.0)  # Set Y-axis range
    ...
    hist4.GetYaxis().SetRangeUser(0.1, 10.0)  # Set Y-axis range
...
# Adjust margins to leave space for axis titles and additional labels
    ...
    # Save the canvas
    c1.SaveAs("dSigmadEta_tau_W10GeV_tagged.pdf")
