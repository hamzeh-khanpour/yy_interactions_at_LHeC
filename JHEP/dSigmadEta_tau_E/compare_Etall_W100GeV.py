...
# Print total entries to the console
    ...
    hist1.GetYaxis().SetTitle("d#sigma/d#eta_{#tau^{+}} [pb]")
    ...
    hist2.GetYaxis().SetTitle("d#sigma/d#eta_{#tau^{+}} [pb]")
    ...
    hist3.GetYaxis().SetTitle("d#sigma/d#eta_{#tau^{+}} [pb]")
    ...
    hist4.GetYaxis().SetTitle("d#sigma/d#eta_{#tau^{+}} [pb]")
