...
from dSigmadY_ep_mumu_10_10_10 import wvalues, elas, inel #, elastagged, elas750GeV
...
# Constants
integrated_cross_section_value_E  = 1.18362346e+02   # pb  from cepgen
integrated_cross_section_value_QE = 5.99555623e+01   # pb  from cepgen
...
#    ax.errorbar(bin_centers, hist_Yll_QE, xerr=DX, yerr=hist_Yll_QE_errors,  marker='.', linestyle='None', linewidth=2, color='green', label='quasi-elastic (cepgen)')
    ...
    plt.savefig("Yll_Comparison_mumu_10_10_10_JHEP.pdf")
    plt.savefig("Yll_Comparison_mumu_10_10_10_JHEP.jpg")
...
compare_distributions("LHeC_Compare_mumu_10_10_10.root")
