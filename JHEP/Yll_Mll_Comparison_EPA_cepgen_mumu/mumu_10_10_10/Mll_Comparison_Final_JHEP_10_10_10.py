...
from wgrid_10_10_10 import *

# ROOT settings
ROOT.gStyle.SetOptStat(0)  # Remove the statistics box from the plots

# Integrated cross-section values
integrated_cross_section_value_E  = 1.18362346e+02   # pb
integrated_cross_section_value_QE = 5.99555623e+01   # pb
...
##################################################################
    ...
    ax.legend(title='$M_N<10$ GeV, ($Q^2_e<10$ GeV$^2$; $Q^2_p<10$ GeV$^2$)', fontsize=20, title_fontsize=20)
...
#    ax.legend(fontsize=20)
    ...
    # Save the plot
    plt.savefig("Mll_Comparison_matplotlib_Final_mumu_10_10_10.pdf")
...
compare_Mll_distributions("LHeC_Compare_mumu_10_10_10.root")
