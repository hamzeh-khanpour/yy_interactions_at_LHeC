...
// found on file: lpair_higgsinos.root
//////////////////////////////////////////////////////////

#ifndef lpair_higgsinos_h
#define lpair_higgsinos_h
...
//   vector<string>  attribute_string;
   ...
   lpair_higgsinos(TTree *tree=0);
   virtual ~lpair_higgsinos();
...
#ifdef lpair_higgsinos_cxx
lpair_higgsinos::lpair_higgsinos(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/event_higgsinos_QE_100000_100000_M100GeV_SuriYennie.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hamzeh-khanpour/hepmc3-build/event_higgsinos_QE_100000_100000_M100GeV_SuriYennie.root");
      }
...
lpair_higgsinos::~lpair_higgsinos()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t lpair_higgsinos::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t lpair_higgsinos::LoadTree(Long64_t entry)
{
...
void lpair_higgsinos::Init(TTree *tree)
{
...
void lpair_higgsinos::Show(Long64_t entry)
{
...
Int_t lpair_higgsinos::Cut(Long64_t entry)
{
...
#endif // #ifdef lpair_higgsinos_cxx
