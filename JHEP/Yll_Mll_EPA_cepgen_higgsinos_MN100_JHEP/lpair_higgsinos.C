#define lpair_higgsinos_cxx
#include "lpair_higgsinos.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void lpair_higgsinos::Loop()
{
//   In a ROOT session, you can do:
//      root> .L lpair_higgsinos.C
//      root> lpair_higgsinos t
...
//      Yll = Etall -  TMath::Cos(Thetall)/2.0 * (Mtau/Ptll)* (Mtau/Ptll);
    ...
    // ----------------------------------------------------
// important if condition here for y_p and Etal_m
// ----------------------------------------------------
...
/*
      ...
      if (Etal_m < -4.0 || Etal_m > 4.0) { continue; }
...
}   // The end of main program lpair_higgsinos
