...
def compare_Etall():
    # Open the ROOT file
    file = ROOT.TFile.Open("LHeC_mumu_E_10_10.root")
    ...
    cross_section_LHeC_E = 1.90946957e-01  # pb
    cross_section_LHeC_E_750GeV = 8.66195014e-02  # pb
    ...
    hist1.GetYaxis().SetRangeUser(0.002, 0.02)
    hist2.GetYaxis().SetRangeUser(0.002, 0.02)
    ...
    hist1.GetYaxis().SetRangeUser(0.002, 0.02)  # Set Y-axis range
    ...
    hist2.GetYaxis().SetRangeUser(0.002, 0.02)  # Set Y-axis range


    # Print integrals
    print(f"Integral of Etall (LHeC_E_W100GEV): {hist1.Integral()} pb")
    print(f"Integral of Etall (LHeC_E_750GeV_W100GeV): {hist2.Integral()} pb")
...
# Adjust margins to leave space for axis titles and additional labels
    ...
    label3.DrawLatex(0.18, 0.76, "W > 100 GeV")


    # Save the canvas
    c1.SaveAs("dSigmadEta_mu_W100GeV.pdf")
#    c1.SaveAs("dSigmadEta_mu_W100GeV.png")
#    c1.SaveAs("dSigmadEta_mu_W100GeV.root")
